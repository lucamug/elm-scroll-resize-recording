...
var _lucamug$elm_meta_json_decoder$Step06$content = F2(
...
var _lucamug$elm_meta_json_decoder$Step06$containerId2 = 'container942';
var _lucamug$elm_meta_json_decoder$Step06$containerId1 = 'container546';
var _lucamug$elm_meta_json_decoder$Step06$model = {position: 0};
var _lucamug$elm_meta_json_decoder$Step06$scrollOrResize = _elm_lang$core$Native_Platform.incomingPort('scrollOrResize', _elm_lang$core$Json_Decode$string);
var _lucamug$elm_meta_json_decoder$Step06$Model = function (a) {
	return {position: a};
};
var _lucamug$elm_meta_json_decoder$Step06$None = {ctor: 'None'};
var _lucamug$elm_meta_json_decoder$Step06$setScrollTopResult = function (result) {
	var _p0 = A2(_elm_lang$core$Debug$log, 'setScrollTopResult', result);
	return _lucamug$elm_meta_json_decoder$Step06$None;
};
var _lucamug$elm_meta_json_decoder$Step06$attemptToSetScrollTop2 = function (position) {
	var _p1 = A2(_elm_lang$core$Debug$log, 'attemptToSetScrollTop2', position);
	return A2(
		_elm_lang$core$Task$attempt,
		_lucamug$elm_meta_json_decoder$Step06$setScrollTopResult,
		A2(_elm_lang$dom$Dom_Scroll$toY, _lucamug$elm_meta_json_decoder$Step06$containerId2, position));
};
var _lucamug$elm_meta_json_decoder$Step06$attemptToSetScrollTop1 = function (position) {
	var _p2 = A2(_elm_lang$core$Debug$log, 'attemptToSetScrollTop1', position);
	return A2(
		_elm_lang$core$Task$attempt,
		_lucamug$elm_meta_json_decoder$Step06$setScrollTopResult,
		A2(_elm_lang$dom$Dom_Scroll$toY, _lucamug$elm_meta_json_decoder$Step06$containerId1, position));
};
var _lucamug$elm_meta_json_decoder$Step06$OnScroll = function (a) {
	return {ctor: 'OnScroll', _0: a};
};
var _lucamug$elm_meta_json_decoder$Step06$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _lucamug$elm_meta_json_decoder$Step06$scrollOrResize(_lucamug$elm_meta_json_decoder$Step06$OnScroll),
			_1: {ctor: '[]'}
		});
};
var _lucamug$elm_meta_json_decoder$Step06$ScrollTo = function (a) {
	return {ctor: 'ScrollTo', _0: a};
};
var _lucamug$elm_meta_json_decoder$Step06$getScrollTopResult = function (result) {
	var _p3 = result;
	if (_p3.ctor === 'Ok') {
		return _lucamug$elm_meta_json_decoder$Step06$ScrollTo(_p3._0);
	} else {
		return _lucamug$elm_meta_json_decoder$Step06$None;
	}
};
var _lucamug$elm_meta_json_decoder$Step06$attemptToGetScrollTop = A2(
	_elm_lang$core$Task$attempt,
	_lucamug$elm_meta_json_decoder$Step06$getScrollTopResult,
	_elm_lang$dom$Dom_Scroll$y(_lucamug$elm_meta_json_decoder$Step06$containerId1));
var _lucamug$elm_meta_json_decoder$Step06$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'ScrollTo':
				var _p5 = _p4._0;
				return (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$Basics$abs(_p5 - model.position),
					20) < 0) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _lucamug$elm_meta_json_decoder$Step06$attemptToSetScrollTop2(_p5),
							_1: {ctor: '[]'}
						})
				};
			case 'None':
			...
			default:
				return {ctor: '_Tuple2', _0: model, _1: _lucamug$elm_meta_json_decoder$Step06$attemptToGetScrollTop};
		}
	});
var _lucamug$elm_meta_json_decoder$Step06$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_lucamug$elm_meta_json_decoder$Step06$ScrollTo(100)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_lucamug$elm_meta_json_decoder$Step06$ScrollTo(0)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_lucamug$elm_meta_json_decoder$Step06$content, _lucamug$elm_meta_json_decoder$Step06$containerId1, '#ffccff'),
						_1: {
							ctor: '::',
							_0: A2(_lucamug$elm_meta_json_decoder$Step06$content, _lucamug$elm_meta_json_decoder$Step06$containerId2, '#ccccff'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _lucamug$elm_meta_json_decoder$Step06$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _lucamug$elm_meta_json_decoder$Step06$model, _1: _elm_lang$core$Platform_Cmd$none},
		view: _lucamug$elm_meta_json_decoder$Step06$view,
		update: _lucamug$elm_meta_json_decoder$Step06$update,
		subscriptions: _lucamug$elm_meta_json_decoder$Step06$subscriptions
	})();

var Elm = {};
Elm['Step06'] = Elm['Step06'] || {};
if (typeof _lucamug$elm_meta_json_decoder$Step06$main !== 'undefined') {
    _lucamug$elm_meta_json_decoder$Step06$main(Elm['Step06'], 'Step06', {"types":{"unions":{"Step06.Msg":{"args":[],"tags":{"OnScroll":["String"],"None":[],"ScrollTo":["Float"]}}},"aliases":{},"message":"Step06.Msg"},"versions":{"elm":"0.18.0"}});
}
