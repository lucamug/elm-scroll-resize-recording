...
var _lucamug$elm_meta_json_decoder$Step02$scrollTo = function (position) {
	return A2(_elm_lang$dom$Dom_Scroll$toY, 'container546', position);
};
var _lucamug$elm_meta_json_decoder$Step02$model = {screenData: _elm_lang$core$Maybe$Nothing};
var _lucamug$elm_meta_json_decoder$Step02$init = {ctor: '_Tuple2', _0: _lucamug$elm_meta_json_decoder$Step02$model, _1: _elm_lang$core$Platform_Cmd$none};
var _lucamug$elm_meta_json_decoder$Step02$scrollOrResize = _elm_lang$core$Native_Platform.incomingPort(
	'scrollOrResize',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (scrollTop) {
					...
					return A2(
						...
						function (viewportHeight) {
							return A2(
								...
								A2(_elm_lang$core$Json_Decode$field, 'viewportWidth', _elm_lang$core$Json_Decode$float));
						},
						A2(_elm_lang$core$Json_Decode$field, 'viewportHeight', _elm_lang$core$Json_Decode$float));
				},
				A2(_elm_lang$core$Json_Decode$field, 'pageHeight', _elm_lang$core$Json_Decode$float));
		},
		A2(_elm_lang$core$Json_Decode$field, 'scrollTop', _elm_lang$core$Json_Decode$float)));
var _lucamug$elm_meta_json_decoder$Step02$ScreenData = F4(
	function (a, b, c, d) {
		return {scrollTop: a, pageHeight: b, viewportHeight: c, viewportWidth: d};
	});
var _lucamug$elm_meta_json_decoder$Step02$Model = function (a) {
	return {screenData: a};
};
var _lucamug$elm_meta_json_decoder$Step02$None = {ctor: 'None'};
var _lucamug$elm_meta_json_decoder$Step02$parseResult = function (result) {
	var _p0 = A2(_elm_lang$core$Debug$log, 'parseResult', result);
	return _lucamug$elm_meta_json_decoder$Step02$None;
};
var _lucamug$elm_meta_json_decoder$Step02$attemptToScrollTo = function (position) {
	var _p1 = A2(_elm_lang$core$Debug$log, 'attemptToScrollTo', position);
	return A2(
		_elm_lang$core$Task$attempt,
		_lucamug$elm_meta_json_decoder$Step02$parseResult,
		_lucamug$elm_meta_json_decoder$Step02$scrollTo(position));
};
var _lucamug$elm_meta_json_decoder$Step02$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'ScrollTo':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _lucamug$elm_meta_json_decoder$Step02$attemptToScrollTo(_p2._0)
				};
			case 'None':
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							screenData: _elm_lang$core$Maybe$Just(_p3)
						}),
					_1: _lucamug$elm_meta_json_decoder$Step02$attemptToScrollTo(_p3.scrollTop)
				};
		}
	});
var _lucamug$elm_meta_json_decoder$Step02$OnScroll = function (a) {
	return {ctor: 'OnScroll', _0: a};
};
var _lucamug$elm_meta_json_decoder$Step02$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _lucamug$elm_meta_json_decoder$Step02$scrollOrResize(_lucamug$elm_meta_json_decoder$Step02$OnScroll),
			_1: {ctor: '[]'}
		});
};
var _lucamug$elm_meta_json_decoder$Step02$ScrollTo = function (a) {
	return {ctor: 'ScrollTo', _0: a};
};
var _lucamug$elm_meta_json_decoder$Step02$view = function (model) {
	return A2(
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_lucamug$elm_meta_json_decoder$Step02$ScrollTo(100)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_lucamug$elm_meta_json_decoder$Step02$ScrollTo(0)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _lucamug$elm_meta_json_decoder$Step02$main = _elm_lang$html$Html$program(
	{init: _lucamug$elm_meta_json_decoder$Step02$init, view: _lucamug$elm_meta_json_decoder$Step02$view, update: _lucamug$elm_meta_json_decoder$Step02$update, subscriptions: _lucamug$elm_meta_json_decoder$Step02$subscriptions})();

var Elm = {};
Elm['Step02'] = Elm['Step02'] || {};
if (typeof _lucamug$elm_meta_json_decoder$Step02$main !== 'undefined') {
    _lucamug$elm_meta_json_decoder$Step02$main(Elm['Step02'], 'Step02', {"types":{"unions":{"Step02.Msg":{"args":[],"tags":{"OnScroll":["Step02.ScreenData"],"None":[],"ScrollTo":["Float"]}}},"aliases":{"Step02.ScreenData":{"args":[],"type":"{ scrollTop : Float , pageHeight : Float , viewportHeight : Float , viewportWidth : Float }"}},"message":"Step02.Msg"},"versions":{"elm":"0.18.0"}});
}
